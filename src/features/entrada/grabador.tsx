    ...
    <div className="flex flex-col items-center gap-8">
      ...
      <div className="relative grid size-40 place-items-center">
        ...
        <button
          ...
          disabled={trabajando}
          className={`relative grid size-24 place-items-center rounded-full transition disabled:opacity-50 ${
        ...
        >
          {trabajando ? (
            <Loader2 className="size-10 animate-spin text-papel" aria-hidden />
          ) : fase.t === 'grabando' ? (
            <Square className="size-8 text-papel" fill="currentColor" aria-hidden />
          ) : (
      ...
      {/* --- Estado ------------------------------------------------------- */}
      <div className="flex min-h-[76px] flex-col items-center gap-3 text-center">
        {fase.t === 'listo' && (
          <>
        ...
        {fase.t === 'grabando' && (
          <>
            <p className="font-mono text-[32px] font-semibold text-ambar-300">
              {String(Math.floor(fase.segundos / 60)).padStart(2, '0')}:
              {String(fase.segundos % 60).padStart(2, '0')}
            </p>
            <p className="flex items-center gap-2 text-[15px] text-texto-consola-2">
              <AudioLines className="size-4" aria-hidden />
              Escuchando. Toque el cuadrado cuando termine.
            </p>
          </>
        )}
        ...
        {fase.t === 'enviando' && (
          <>
            <p className="text-[17px] font-semibold text-texto-consola">{fase.paso}</p>
            <p className="max-w-[440px] text-[14px] leading-6 text-texto-consola-3">
        ...
        {fase.t === 'error' && (
          <div className="flex max-w-[480px] items-start gap-3 rounded-[18px] border border-[#EFB56944] bg-[#C97A2218] p-4 text-left">
